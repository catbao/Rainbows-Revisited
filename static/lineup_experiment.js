function LineupExperiment(w, h, _lineupN, trialOrder, blockOrder, gMain, gDecoy, nullOption)
{
    ...
    this.lineup = new Lineup(w, h, _lineupN, this.main, this.decoy, nullOption, trialOrder, blockOrder);
